...
{
    public class RetireModel : DI_BasePageModel
    {
        public RetireModel(RacingLeagueManagerContext context,
        ...
        public async Task<IActionResult> OnPostAsync(Guid? leagueId, Guid? seriesEntryId, Guid? driverId)
        {
            ...
            driver.DriverType = DriverType.Retired;
            seriesDriver.Status = "Unavailable - Retired";
