...
{
    public class LeagueAuthorizationHandler
                : AuthorizationHandler<OperationAuthorizationRequirement, League>
    {
        UserManager<Driver> _userManager;

        public LeagueAuthorizationHandler(UserManager<Driver>
            userManager)
        {
