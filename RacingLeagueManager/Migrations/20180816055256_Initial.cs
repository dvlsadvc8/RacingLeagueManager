        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnedLeagueId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Series_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RaceNumber = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SeriesEntry_Series_SeriesId",
                        column: x => x.SeriesId,
                        principalTable: "Series",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SeriesEntry_Team_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Team",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeriesEntryId = table.Column<Guid>(nullable: false),
                    DriverId = table.Column<Guid>(nullable: false),
                    BestLap = table.Column<TimeSpan>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RaceResult_AspNetUsers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RaceResult_SeriesEntry_SeriesEntryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeriesEntryDriver", x => new { x.LeagueId, x.DriverId, x.SeriesEntryId });
                    table.ForeignKey(
                        name: "FK_SeriesEntryDriver_SeriesEntry_SeriesEntryId",
                        column: x => x.SeriesEntryId,
                        principalTable: "SeriesEntry",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SeriesEntryDriver_LeagueDriver_LeagueId_DriverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RaceResult_SeriesEntryId",
                table: "RaceResult",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeriesEntry_CarId",
                table: "SeriesEntry",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_SeriesEntry_SeriesId",
                table: "SeriesEntry",
                column: "SeriesId");

            migrationBuilder.CreateIndex(
                name: "IX_SeriesEntry_TeamId",
                table: "SeriesEntry",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_SeriesEntryDriver_SeriesEntryId",
